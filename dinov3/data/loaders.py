...
from .datasets import ADE20K, COCOSegmentation, CocoCaptions, ImageNet, ImageNet22k, NYU
...
def _parse_dataset_str(dataset_str: str):
    ...
    elif name == "COCOSegmentation":
        class_ = COCOSegmentation
        if "split" in kwargs:
            kwargs["split"] = COCOSegmentation.Split[kwargs["split"]]
    else:
