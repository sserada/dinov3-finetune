## bepli_v2 セグメンテーション実験について

このリポジトリは DINOv3 を fork し、海洋デブリデータセット（bepli_v2）でのセグメンテーション実験を行ったものです。
実験結果・変更内容・原因分析の詳細は **[docs/bepli_v2_segmentation_report.md](docs/bepli_v2_segmentation_report.md)** を参照してください。
